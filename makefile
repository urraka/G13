...
win32:
	@mkdir -p bin/win32
	g++ -o bin/win32/G13.exe $(src) -lglew32 -lglfw -lopengl32 -Isrc -DGLEW_STATIC -DWIN32 -O2

win32-d:
	@mkdir -p bin/win32
	g++ -o bin/win32/G13.exe $(src) -lglew32 -lglfw -lopengl32 -Isrc -DGLEW_STATIC -DWIN32 -DDEBUG -g
